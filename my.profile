# Custom C2 Profile for CRTO (Modified by 0xflux)
set sample_name "Voldemort";
set sleeptime "2000";
set jitter    "20";
set useragent "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.87 Safari/537.36";
set host_stage "true";

# TLS cert options using a self signed cert
https-certificate {
     set CN   "fluxmalware.com";
     set O    "Flux’s Malware";
     set C    "US";
}
